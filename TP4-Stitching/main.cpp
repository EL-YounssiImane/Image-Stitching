...
int main(int argc, char* argv[]) {
    ...
    //USING CORNER_BRISK
    //_myFeatureDetector1.changeFeatureDetector(_CORNER_BRISK);
    //_myFeatureDetector2.changeFeatureDetector(_CORNER_BRISK);
    ...
    // TODO: detect Features in img2 here!
    ...
    // Computing Descriptors USING DESC_BRISK
    //_myFeatureExtractor1.changeDescriptorExtractor(_DESC_BRISK);
    //_myFeatureExtractor2.changeDescriptorExtractor(_DESC_BRISK);

    // Computing Descriptors USING DESC_ORB
    ...
    // Matching keypoints
    _myDescriptorMatcher.match(_myFeatureExtractor1.getDescriptors(),_myFeatureExtractor2.getDescriptors(), _myMatches, _myBestMatches);

    // Drawing matching result
    // TODO: call drawMatchingResults and get the returned value
    matchingResult = _myDescriptorMatcher.drawMatchingResults(_myFeatureDetector1.getImage(), 
        _myFeatureDetector1.getFeatures(), _myFeatureDetector2.getImage(), 
        _myFeatureDetector2.getFeatures(), _myBestMatches);
